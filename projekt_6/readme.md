Program pobiera od użytkownika hasło główne.
1. Wybieramy 'stworz', program prosi o nazwę użtkownika i jego hasło.Otrzymujemy plik passwords.txt, z widocznym użytkownikiem i zakodowanym hasłem.
